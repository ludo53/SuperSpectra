...
#[derive(Debug)]
pub struct SuperSpectraProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SuperSpectraProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SuperSpectra processing");
    
    let mut processor = SuperSpectraProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SuperSpectraProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SuperSpectraProcessor::new(false);
